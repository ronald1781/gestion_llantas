<section clase="container">
    <script type="text/javascript">
        ...
        function edit_person(id)
        {
            ...
            $.ajax({
                url: "control_marca/ajax_edit/" + id,
                type: "GET",
                dataType: "JSON",
        ...
        function save()
        {
...

            {
                ...
                url = "control_marca/ajax_add";
            }
            else
            {
                url = "control_marca/ajax_update";
            }
        ...
        function delete_person(id)
        {
            if (confirm('Esta Seguro de Eliminar Este Dato?'))
            {
                ...
                $.ajax({
                    url: "control_marca/ajax_delete/" + id,
                    type: "POST",
                    dataType: "JSON",
                    success: function (data)
    ...
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-heading"> <p align="right"><button class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Registrar Marca</button></p>
            </div>
