...
(function (c) {
    ...
    c.fn.filestyle.defaults = {buttonText: "Buscar", iconName: "glyphicon-folder-open", buttonName: "btn-default", size: "nr", input: true, badge: true, icon: true, buttonBefore: false, disabled: false};
